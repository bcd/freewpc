...
const struct {
	...
	{ "GOTTLIEBS HUMPTY DUMPTY", "MANUFACTURED IN 1947 WAS", "THE FIRST TABLE TO HAVE", "PLAYER CONTROLLER FLIPPERS" },
	{ "WILLIAMS SARATOGA", "MANUFACTURED IN 1948 WAS", "THE FIRST TABLE TO HAVE", "THE STANDARD FLIPPER LAYOUT" },
	{ "BALLYS BALLS-A-POPPIN", "MANUFACTURED IN 1956 WAS", "THE FIRST TABLE TO HAVE", "MULTIBALL" },
	{ "WILLIAMS GORGAR", "MANUFACTURED IN 1979 WAS", "THE FIRST TABLE TO HAVE", "SYNTHETIC SPEECH" },
