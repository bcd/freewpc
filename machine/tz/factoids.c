...
const struct {
	...
	{ "THE SLOT MACHINE", "ON THE PLAYFIELD AND BACKGLASS", "IS FROM THE EPISODE", "THE FEVER" },
	{ "THE PLAYER PIANO", "ON THE PLAYFIELD AND BACKGLASS", "IS FROM THE EPISODE", "A PIANO IN THE HOUSE" },
	{ "THE CAMERA", "ON THE PLAYFIELD AND BACKGLASS", "IS FROM THE EPISODE", "A MOST UNUSUAL CAMERA" },
	{ "WILLIAMS MANUFACTURED", "15,235 UNITS OF TWILIGHT ZONE", "COMPARED TO 20,270 UNITS", "FOR THE ADDAMS FAMILY" },
	{ "DEVELOPMENT ON FREEWPC STARTED", "IN 2005 AND THE FIRST HARDWARE TEST", "HAPPENED ON BCDS WCS IN", "MAY 2008" },
