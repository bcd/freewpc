...
#define SPCH_LANDING_IN_CHICAGO          SPEECH_SND(0x40)
#define SPCH_LANDING_IN_DALLAS           SPEECH_SND(0x41)
#define SPCH_LANDING_IN_BOSTON           SPEECH_SND(0x42)
#define SPCH_LANDING_IN_NEW_YORK         SPEECH_SND(0x43)
#define SPCH_LANDING_IN_NEW_JERSEY       SPEECH_SND(0x44)
#define SPCH_LANDING_IN_ORLANDO          SPEECH_SND(0x45)
#define SPCH_LANDING_IN_WASHINGTON_DC    SPEECH_SND(0x46)
#define SPCH_LANDING_IN_SAN_FRANCISCO    SPEECH_SND(0x47)
