...
#define MOD_LAMP 1
	#define EV_LEFF_START 0
	#define EV_LEFF_STOP 1
	#define EV_LEFF_RESTART 2
	#define EV_LEFF_EXIT 3
	#define EV_LAMP_ON 4
	#define EV_LAMP_OFF 5
	#define EV_LAMP_FLASH 6
	#define EV_BIT_ON 7
	#define EV_BIT_OFF 8
	#define EV_GLOBAL_BIT_ON 9
	#define EV_GLOBAL_BIT_OFF 10
...
#define MOD_TASK 3
	#define EV_TASK_START 0
	#define EV_TASK_KILL 1
	#define EV_TASK_RESTART 2
	#define EV_TASK_START1 3
	#define EV_TASK_EXIT 4
...
#define MOD_SOL 9
	#define EV_SOL_START 0
	#define EV_SOL_STOP 1
