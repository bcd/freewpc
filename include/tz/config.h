...
#define MACHINE_START_GAME_SOUND		SND_ARE_YOU_READY_TO_BATTLE
...
#define MACHINE_DISPLAY_EFFECTS \
	...
	DECL_DEFF (DEFF_LOCK_LIT, D_NORMAL, PRI_GAME_MODE1+2, lock_is_lit_deff) \
	DECL_DEFF (DEFF_MB_LIT, D_NORMAL, PRI_GAME_MODE1+2, multiball_is_lit_deff) \
	...
	DECL_DEFF (DEFF_CAMERA_AWARD, D_NORMAL, PRI_GAME_MODE1+5, camera_award_deff) \
	DECL_DEFF (DEFF_DOOR_AWARD, D_NORMAL, PRI_GAME_MODE1+5, door_award_deff) \
	DECL_DEFF (DEFF_MB_START, D_NORMAL, PRI_GAME_MODE1+7, multiball_start_deff) \
...
DECL_LEFF (LEFF_MB_RUNNING, L_NORMAL, PRI_LEFF2, LAMPSET_DOOR_LOCKS_AND_GUMBALL, L_NOGI, multiball_running_leff)
...
#define MACHINE_8MS_RTTS \
	...
	VOIDCALL(jets_rtt) \
	VOIDCALL(magnet_switch_rtt)

#define MACHINE_32MS_RTTS \
	VOIDCALL(tz_clock_rtt) \
	VOIDCALL(magnet_duty_rtt)
